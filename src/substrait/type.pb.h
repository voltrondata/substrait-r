...
typedef struct _substrait_Type { 
    ...
    union {
        ...
        struct _substrait_Type_UserDefined *user_defined;
...
typedef struct _substrait_Type_UserDefined { 
...
#define substrait_Type_kind_user_defined_MSGTYPE substrait_Type_UserDefined
