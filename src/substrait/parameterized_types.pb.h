...
typedef struct _substrait_ParameterizedType { 
    ...
    union {
        ...
        struct _substrait_ParameterizedType_ParameterizedUserDefined *user_defined;
...
typedef struct _substrait_ParameterizedType_ParameterizedUserDefined { 
    uint32_t *type_pointer;
    uint32_t *variation_pointer;
    substrait_Type_Nullability *nullability;
} substrait_ParameterizedType_ParameterizedUserDefined;
...
#define substrait_ParameterizedType_ParameterizedUserDefined_init_default {NULL, NULL, NULL}
...
#define substrait_ParameterizedType_ParameterizedUserDefined_init_zero {NULL, NULL, NULL}
...
#define substrait_ParameterizedType_user_defined_tag 30
...
#define substrait_ParameterizedType_ParameterizedUserDefined_type_pointer_tag 1
#define substrait_ParameterizedType_ParameterizedUserDefined_variation_pointer_tag 2
#define substrait_ParameterizedType_ParameterizedUserDefined_nullability_tag 3
...
#define substrait_ParameterizedType_kind_user_defined_MSGTYPE substrait_ParameterizedType_ParameterizedUserDefined
...
#define substrait_ParameterizedType_ParameterizedUserDefined_FIELDLIST(X, a) \
X(a, POINTER,  SINGULAR, UINT32,   type_pointer,      1) \
X(a, POINTER,  SINGULAR, UINT32,   variation_pointer,   2) \
X(a, POINTER,  SINGULAR, UENUM,    nullability,       3)
#define substrait_ParameterizedType_ParameterizedUserDefined_CALLBACK NULL
#define substrait_ParameterizedType_ParameterizedUserDefined_DEFAULT NULL
...
extern const pb_msgdesc_t substrait_ParameterizedType_ParameterizedUserDefined_msg;
...
#define substrait_ParameterizedType_ParameterizedUserDefined_fields &substrait_ParameterizedType_ParameterizedUserDefined_msg
...
/* substrait_ParameterizedType_ParameterizedUserDefined_size depends on runtime parameters */
