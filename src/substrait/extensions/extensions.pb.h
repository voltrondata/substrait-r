...
typedef struct _substrait_extensions_SimpleExtensionDeclaration { 
    ...
    union {
        pb_callback_t extension_type;
        pb_callback_t extension_type_variation;
        pb_callback_t extension_function;
    } mapping_type; 
...
typedef struct _substrait_extensions_SimpleExtensionDeclaration_ExtensionFunction { 
    pb_callback_t extension_uri_reference; 
    pb_callback_t function_anchor; 
    pb_callback_t name; 
...
typedef struct _substrait_extensions_SimpleExtensionDeclaration_ExtensionTypeVariation { 
    pb_callback_t extension_uri_reference; 
    pb_callback_t type_variation_anchor; 
    pb_callback_t name; 
...
typedef struct _substrait_extensions_SimpleExtensionURI { 
 ...
 URI associated with an extension. */
    pb_callback_t extension_uri_anchor; 
...
#define substrait_extensions_SimpleExtensionURI_init_default {{{NULL}, NULL}, {{NULL}, NULL}}
#define substrait_extensions_SimpleExtensionDeclaration_init_default {0, {{{NULL}, NULL}}}
#define substrait_extensions_SimpleExtensionDeclaration_ExtensionType_init_default {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
#define substrait_extensions_SimpleExtensionDeclaration_ExtensionTypeVariation_init_default {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
#define substrait_extensions_SimpleExtensionDeclaration_ExtensionFunction_init_default {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
#define substrait_extensions_AdvancedExtension_init_default {{{NULL}, NULL}, {{NULL}, NULL}}
#define substrait_extensions_SimpleExtensionURI_init_zero {{{NULL}, NULL}, {{NULL}, NULL}}
#define substrait_extensions_SimpleExtensionDeclaration_init_zero {0, {{{NULL}, NULL}}}
#define substrait_extensions_SimpleExtensionDeclaration_ExtensionType_init_zero {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
#define substrait_extensions_SimpleExtensionDeclaration_ExtensionTypeVariation_init_zero {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
#define substrait_extensions_SimpleExtensionDeclaration_ExtensionFunction_init_zero {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
#define substrait_extensions_AdvancedExtension_init_zero {{{NULL}, NULL}, {{NULL}, NULL}}
...
X(a, CALLBACK, SINGULAR, UINT32,   extension_uri_anchor,   1) \
X(a, CALLBACK, SINGULAR, STRING,   uri,               2)
#define substrait_extensions_SimpleExtensionURI_CALLBACK pb_default_field_callback
...
X(a, CALLBACK, ONEOF,    MESSAGE,  (mapping_type,extension_type,mapping_type.extension_type),   1) \
X(a, CALLBACK, ONEOF,    MESSAGE,  (mapping_type,extension_type_variation,mapping_type.extension_type_variation),   2) \
X(a, CALLBACK, ONEOF,    MESSAGE,  (mapping_type,extension_function,mapping_type.extension_function),   3)
#define substrait_extensions_SimpleExtensionDeclaration_CALLBACK pb_default_field_callback
...
X(a, CALLBACK, SINGULAR, UINT32,   extension_uri_reference,   1) \
X(a, CALLBACK, SINGULAR, UINT32,   type_anchor,       2) \
X(a, CALLBACK, SINGULAR, STRING,   name,              3)
#define substrait_extensions_SimpleExtensionDeclaration_ExtensionType_CALLBACK pb_default_field_callback
...
X(a, CALLBACK, SINGULAR, UINT32,   extension_uri_reference,   1) \
X(a, CALLBACK, SINGULAR, UINT32,   type_variation_anchor,   2) \
X(a, CALLBACK, SINGULAR, STRING,   name,              3)
#define substrait_extensions_SimpleExtensionDeclaration_ExtensionTypeVariation_CALLBACK pb_default_field_callback
...
X(a, CALLBACK, SINGULAR, UINT32,   extension_uri_reference,   1) \
X(a, CALLBACK, SINGULAR, UINT32,   function_anchor,   2) \
X(a, CALLBACK, SINGULAR, STRING,   name,              3)
#define substrait_extensions_SimpleExtensionDeclaration_ExtensionFunction_CALLBACK pb_default_field_callback
...
X(a, CALLBACK, OPTIONAL, MESSAGE,  optimization,      1) \
X(a, CALLBACK, OPTIONAL, MESSAGE,  enhancement,       2)
#define substrait_extensions_AdvancedExtension_CALLBACK pb_default_field_callback
